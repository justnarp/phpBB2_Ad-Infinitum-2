...
<div align="center"><span class="copyright">Powered by <a href="http://www.phpbb.com/" target="_phpbb">phpBB</a> {PHPBB_VERSION} and <a href="http://www.mikelothar.com/" target="_mikelothar">AI2</a> v2.5<br />{TRANSLATION_INFO}</span></div>
