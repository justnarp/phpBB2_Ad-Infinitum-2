<!--
	The original AI2 v2.5 skin for phpBB version 2+
...
<link rel="icon"
	href="templates/AI2/images/favicon.ico" />
...
<script type="text/javascript" 
	src="templates/AI2/overlib.js"></script>
...
<table cellspacing="0" id="forum">
	<tr>
		...
		<div id="top_image">
			<a href="{U_INDEX}"><img src="templates/AI2/images/top_image.jpg" alt="{L_INDEX}" /></a>
		</div>
	...
	<div class="menu2">
		...
		<div class="right mainmenu">
			...
			{L_USERNAME}: <input class="post postsmall toplogin" type="text" name="username" />&nbsp;
			{L_PASSWORD}: <input class="post postsmall toplogin" type="password" name="password" maxlength="32" />
